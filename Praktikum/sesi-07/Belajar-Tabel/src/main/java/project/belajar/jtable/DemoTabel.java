...
public class DemoTabel{
    ...
    private static List<Mahasiswa> sampleData(){
        ...
        m1.setNpm("4510210001");
        m1.setNama("M Rafii Pratama");
        data.add(m1);
        
        Mahasiswa m2 = new Mahasiswa();
        m2.setNpm("4510210002");
        m2.setNama("Irvan Abdurrahman");
        data.add(m2);
        
        Mahasiswa m3 = new Mahasiswa();
        m3.setNpm("4510210003");
        m3.setNama("M Sidratul Muntaha");
        data.add(m3);
        
        Mahasiswa m4 = new Mahasiswa();
        m4.setNpm("4510210004");
        m4.setNama("Febri Damatraseta");
        data.add(m4);
        
        Mahasiswa m5 = new Mahasiswa();
        m5.setNpm("4510210005");
        m5.setNama("Denni Kurniawan");
        data.add(m5);
